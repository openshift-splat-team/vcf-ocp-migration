...
import (
	...
	"github.com/openshift-splat-team/vcf-ocp-migration/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "951fca85.openshift.io",
	...
	machClient, err := machineclient.NewForConfig(restConfig)
	if err != nil {
		setupLog.Error(err, "unable to create machine client")
		os.Exit(1)
	}
