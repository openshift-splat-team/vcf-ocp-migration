...
# openshift.io/vcf-ocp-migration-bundle:$VERSION and openshift.io/vcf-ocp-migration-catalog:$VERSION.
IMAGE_TAG_BASE ?= openshift.io/vcf-ocp-migration
...
# The default setup assumes Kind is pre-installed and builds/loads the manager image locally.
# CertManager is installed by default; skip with:
# - CERT_MANAGER_INSTALL_SKIP=true
KIND_CLUSTER ?= vcf-ocp-migration-test-e2e
...
operator-image: ## Build container image with the manager.
	$(CONTAINER_TOOL) build -t ${IMG} .

.PHONY: operator-push
operator-push: ## Push the manager container image.
